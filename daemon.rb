...
Wonga::Daemon.run(Wonga::Daemon::PantryDnsRecordDeleteCommandHandler.new(Wonga::Daemon.config['ad']['username'], Wonga::Daemon.config['ad']['password'], Wonga::Daemon.publisher, Wonga::Daemon.logger, Wonga::Daemon.config))
